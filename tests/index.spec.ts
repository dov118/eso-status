...
describe('getBlocksDate()', () => {
  it('check format - (2021.01.14 - 12:00 UTC (7:00 EST))', () => {
  ...
  it('check format - (2021.02.01 - 13:00 UTC (8:00 EST))', () => {
    const initialDateLine = {
  ...
  it('check format - (2021.01.26 - 08:00 UTC (03:00 EST))', () => {
    const initialDateLine = {
...
describe('getBlockInformation()', () => {
  it('check format - (The European megaservers are currently unavailable while we perform maintenance.)', () => {
  ...
  it('check format - (The North American megaservers are currently available. - The European megaservers are currently available.)', () => {
    const initialInformationLines = [
      {
...
describe('getInformationLineServerSlug', () => {
  rawExemples.forEach((exemple: any): void => {
    it(`check format (${exemple.index}) - (${exemple.rawStatus})`, () => {
...
describe('getInformationLineServerStatus', () => {
  rawExemples.forEach((exemple: any): void => {
    it(`check format (${exemple.index}) - (${exemple.rawStatus})`, () => {
...
describe('getInformationLineServerZone', () => {
  slugZoneSupportExemples.forEach((exemple: any): void => {
    it(`check format - (${exemple.slug})`, () => {
...
describe('getInformationLineServerSupport', () => {
  slugZoneSupportExemples.forEach((exemple: any): void => {
    it(`check format - (${exemple.slug})`, () => {
